...
from evennia import default_cmds #why was this commented out?
...
class CmdTestMenu(Command):
    ...
    # def menunode_one(caller, raw_string):
    #     text = "The server daemon squints at you with rheumy eyes. 'What do you want?' It grumbles."
    #     options = (
    #         {"desc": "'Where am I?'"
    #          "goto": "node_where"},
    #          {"desc": "'What are you?'",
...
# class CharGenMenu(Command):
#     """
#     Trying to do chargen in menu form!
#     """
#     key = "chargen"
#     def func(self):
#         EvMenu(caller, "world.mymenu")
#
#     def menunode_one(caller, raw_string):
#         text = "Welcome to FLESHWORLD. Recreate yourself."
#         options = (
#             {"desc": ""}
#         )
